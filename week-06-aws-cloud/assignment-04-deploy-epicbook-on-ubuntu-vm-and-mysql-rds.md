...
![alt text](screenshots/week-06-Assignment-04-screenshot1.png)

---

#### Screenshot 2 — Subnets list showing both subnets and their CIDRs

![alt text](screenshots/week-06-Assignment-04-screenshot2.png)

---

#### Screenshot 3 — Route table showing 0.0.0.0/0 → IGW and association with the public subnet

![alt text](screenshots/week-06-Assignment-04-screenshot3.png)![alt text](screenshots/week-06-Assignment-04-screenshot3-2.png)
...
![alt text](screenshots/week-06-Assignment-04-screenshot4.png)

---

#### Screenshot 5 — RDS security-group inbound rule showing MySQL 3306 allowed from the EC2 security group

![alt text](screenshots/week-06-Assignment-04-screenshot5.png)
...
![alt text](screenshots/week-06-Assignment-04-screenshot6.png)![alt text](screenshots/week-06-Assignment-04-screenshot6-1.png)![alt text](screenshots/week-06-Assignment-04-screenshot6-2.png)
...
![alt text](screenshots/week-06-Assignment-04-screenshot7.png)
...
![alt text](screenshots/week-06-Assignment-04-screenshot8.png)

---

#### Screenshot 9 — Output of `systemctl status nginx`

![alt text](screenshots/week-06-Assignment-04-screenshot9.png)

---

#### Screenshot 10 — Output of `mysql --version`

![alt text](screenshots/week-06-Assignment-04-screenshot10.png)
...
![alt text](screenshots/week-06-Assignment-04-screenshot11.png)

---

#### Screenshot 12 — Connectivity & security section showing the VPC and attached security group

![alt text](screenshots/week-06-Assignment-04-screenshot12.png)
...
![alt text](screenshots/week-06-Assignment-04-screenshot13.png)
...
![alt text](screenshots/week-06-Assignment-04-screenshot14.png)

---

#### Screenshot 15 — Terminal showing the backend running, or `ss -tulpn` showing the port open

![alt text](screenshots/week-06-Assignment-04-screenshot15.png)

---

#### Screenshot 16 — `curl` output proving the backend responds

![alt text](screenshots/week-06-Assignment-04-screenshot16.png)
...
![alt text](screenshots/week-06-Assignment-04-screenshot17.png)

---

#### Screenshot 18 — Nginx configuration snippet showing the `/api/` reverse proxy

![alt text](screenshots/week-06-Assignment-04-screenshot18.png)
...
![alt text](screenshots/week-06-Assignment-04-screenshot19.png)

---

#### Screenshot 20 — Terminal showing a successful API call through the public endpoint

![alt text](screenshots/week-06-Assignment-04-screenshot20.png)

---

#### Screenshot 21 — Terminal showing a successful database connectivity test (`SELECT 1;` or similar)

![alt text](screenshots/week-06-Assignment-04-screenshot21.png)
