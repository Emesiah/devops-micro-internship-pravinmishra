...
![alt text](screenshots/week-07-Assignment-07-screenshot1.png)
...
![alt text](screenshots/week-07-Assignment-07-screenshot2.png)
...
![alt text](screenshots/week-07-Assignment-07-screenshot3.png)
...
![alt text](screenshots/week-07-Assignment-07-screenshot4.png)

---

#### Screenshot 5 — Output of `bash -n` (no syntax errors) and `ls -l` showing the script is executable

![alt text](screenshots/week-07-Assignment-07-screenshot5.png)
...
![alt text](screenshots/week-07-Assignment-07-screenshot6.png)
...
![alt text](screenshots/week-07-Assignment-07-screenshot7.png)

---

#### Screenshot 8 — `/azure-audit` output showing the baseline findings and Claude's explanation

![alt text](screenshots/week-07-Assignment-07-screenshot8.png)
...
![alt text](screenshots/week-07-Assignment-07-screenshot9.png)

---

#### Screenshot 10 — Terminal output of the remediation command you ran yourself

![alt text](screenshots/week-07-Assignment-07-screenshot10.png)

---

#### Screenshot 11 — Second `/azure-audit` run (or report) showing the finding resolved

![alt text](screenshots/week-07-Assignment-07-screenshot11.png)
...
* SSH/Network Access: Azure NSG SSH exposure = AWS Security Group SSH exposure.
* Public Storage: Azure Blob public access = AWS S3 public access.
* Database Exposure: Azure MySQL public access = AWS RDS public access.
* Disk Encryption: Azure VM disk encryption = AWS EBS encryption.

Same Workflow:

Even though the `az` and `aws` commands are different, the process stayed the same:

1. Gather → 2. Analyze → 3. Human Remediation → 4. Re-Verify

The audit collects security data, AI analyzes the findings, a human applies the fixes, and the audit runs again to confirm the resources are secure.

In a nutshell,The cloud commands changed, but the security audit method remained the same.
